...
- `menu-data.js` - editable restaurant details, WhatsApp number, categories, items, and prices
- `app.js` / `admin.js` - page rendering and admin editing behavior

## How to use

1. Update `menu-data.js` with the real phone number, WhatsApp number, address, items, and prices.
